...
class RejectedVerificationScreen extends StatelessWidget {
  ...
  const RejectedVerificationScreen({Key? key, required this.userVerification})
      : super(key: key);
          ...
          Padding(
            ...
            child: Center(
              child: ElevatedButton(
                onPressed: () {
                  //userverification CancelUserVerification
                  BlocProvider.of<UserVerificationBloc>(context)
                      .add(RestartVerification());
