...
class UserCard extends StatelessWidget {
  ...
  const UserCard({Key? key, required this.user, required this.imageUrlIndex})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    SwipeLoaded swipeState =
        Provider.of<SwipeBloc>(context).state as SwipeLoaded;
          ...
          child: Stack(
            children: [
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        ...
                        image: CachedNetworkImageProvider(
                            user!.imageUrls[swipeState.imageUrlIndex])),
              ...
              GestureDetector(child: LayoutBuilder(builder: (ctx, constraints) {
                ...
                Provider.of<SwipeBloc>(context, listen: false)
                    .add(IncrementSwipeImageUrlIndex());
              }),
              GestureDetector(child: LayoutBuilder(builder: (ctx, constraints) {
                return Align(
                ...
                Provider.of<SwipeBloc>(context, listen: false)
                    .add(DecrementSwipeImageUrlIndex());
              }),
              Positioned(
                bottom: 30,
                left: 20,
